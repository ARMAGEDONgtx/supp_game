...
public:
    ...
    void zaladuj_textury();
    void zaladuj_textury2();
    ...
    bool czy_moze_lewo, czy_moze_prawo, czy_moze_skok;
    bool zezwolenie_na_skok;
    void aktualizuj();
    float zwroc_x_gracza();
